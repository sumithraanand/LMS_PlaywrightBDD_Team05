...
export class BatchPage {
    ...
    constructor(page) {
       ...
       // Actions
        ...
        this.batchDetailsCloseIcon =this.batchDetailsDialog.locator('button.p-dialog-header-icon');
        ...
        this.batchDetailsCancelButton = this.batchDetailsDialog.getByRole('button', {name: 'Cancel',exact: true});
        ...
        this.deleteConfirmationCloseIcon = this.confirmDialog.locator('button.p-dialog-header-icon');
...
// Add Batch Methods
   ...
   async enterInvalidBatchNameSuffix() {
    ...
    async enterValidDataAndCancel() {
        ...
        await this.batchDetailsCancelButton.click();
    }
